...
struct `MCP directory move contract` {
    ...
    @Test
    func `Schema describes one closed recursive move`() throws {
        ...
        #expect(outputRequired == ["source_path", "destination_path"])
    ...
    func `Controller strictly decodes and routes canonical request values`() async throws {
        ...
        #expect(Set(structured.keys) == ["source_path", "destination_path"])
