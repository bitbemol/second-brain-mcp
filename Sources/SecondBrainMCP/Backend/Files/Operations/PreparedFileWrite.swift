...
/// generic persistence plus output returned only after persistence and Git
/// sequencing succeed. Keeping this type in Backend prevents mutation mechanics
...
struct PreparedFileWrite: Sendable {
    ...
    let data: Data
    /// Result returned after persistence and Git sequencing succeed.
