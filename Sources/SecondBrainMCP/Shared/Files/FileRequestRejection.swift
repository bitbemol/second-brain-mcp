/// A vault request rejected at the transport boundary before backend routing.
struct FileRequestRejection: Equatable, Sendable {
    ...
    /// Vault operation the client attempted.
...
/// Transport-neutral sink for vault requests rejected before backend routing.
