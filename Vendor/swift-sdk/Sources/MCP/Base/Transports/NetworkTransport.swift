// Modified by SecondBrainMCP: make an existing strong Task capture explicit for Swift 6.4.
// Upstream revision and patch rationale: Vendor/swift-sdk/README.md.
import Foundation
import Logging
